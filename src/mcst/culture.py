...
class AsyncCultureOpenApiClient:
    ...
    async def media_famous_places(self, **kwargs: Any) -> Page[CultureRecord]:
        return await self.request("media_famous_places", **kwargs)

    async def barrier_free_places(self, **kwargs: Any) -> Page[CultureRecord]:
        return await self.request("barrier_free_places", **kwargs)

    async def pet_friendly_culture_facilities(self, **kwargs: Any) -> Page[CultureRecord]:
        return await self.request("pet_friendly_culture_facilities", **kwargs)

    async def leisure_activity_facilities(self, **kwargs: Any) -> Page[CultureRecord]:
        return await self.request("leisure_activity_facilities", **kwargs)

    async def leisure_camping_facilities(self, **kwargs: Any) -> Page[CultureRecord]:
        return await self.request("leisure_camping_facilities", **kwargs)
